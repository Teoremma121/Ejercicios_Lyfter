...
# Emmanuel Piedra
# Programa 02
# Lea sobre el resto de métodos del módulo csv aqui y cree una version alternativa
# del ejercicio de arriba que guarde el archivo separado por tabulaciones en vez de por comas.
