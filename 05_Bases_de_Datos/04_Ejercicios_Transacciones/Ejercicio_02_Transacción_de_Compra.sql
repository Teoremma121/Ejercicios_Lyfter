...
DECLARE
    ...
    v_product_01_id INTEGER := 2;
	v_product_02_id INTEGER := 10;
	v_product_03_id INTEGER := 7;
	v_product_01_quantity INTEGER := 3;
	v_product_02_quantity INTEGER := 2;
	v_product_03_quantity INTEGER := 1;
	v_product_01_price REAL;
	v_product_02_price REAL;
	v_product_03_price REAL;
	v_available_stock INTEGER;
	v_buyer VARCHAR(50) := 'pompom_pudding';
	v_user_id INTEGER;
	v_bill_id INTEGER;
	v_total_amount REAL;
